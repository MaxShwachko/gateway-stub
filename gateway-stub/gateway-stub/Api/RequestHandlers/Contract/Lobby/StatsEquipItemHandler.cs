...
namespace GatewayStub.Api.RequestHandlers.Contract.Lobby
{
    public class StatsEquipItemHandler : IContractRequestHandler
    {
        ...
        public async Task Handle(IContractRequestData request)
        {
            ...
            await _socket.Send(new StatsEquipItemResponse(EGatewayErrorCode.Success, equipment.EquippedItemBindingUid,
                equipment.EquippedItemSlotUid, equipment.EquipmentBonuses, equipment.EquippedItemHeroUid));
        }
    }
}